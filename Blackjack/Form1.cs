    ...
    public partial class Form1 : Form
    {
         ...
         private void startButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    resultLabel.Text = String.Format
                        ("Кількість твоїх очок: {0}, ти переміг!", playercardSum);
                    MessageBox.Show("Ти переміг!", "", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    resetGame();
                }
        ...
        private void DealButton_Click(object sender, EventArgs e)
        {
            if (playercardSum == 0)
            {
                resultLabel.Text = "Натисніть кнопку 'Почати гру'";
            }
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        resultLabel.Text = String.Format
                            ("Кількість твоїх очок: {0}, ти програв!", playercardSum);
                        MessageBox.Show("Ти програв!", "", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        resetGame();
                    }
                    else if (playercardSum == 21)
                    {
                        resultLabel.Text = String.Format
                            ("Кількість твоїх очок: {0}, ти виграв!", playercardSum);
                        MessageBox.Show("Ти виграв!", "", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        resetGame();
                    }
                }
            }
        ...
        private void PlayerStopButton_Click(object sender, EventArgs e)
        {
            ...
            {
                resultLabel.Text = String.Format
                    ("Кількість очок круп'є: {0}, ти переміг!", bankercardSum);
                MessageBox.Show("Ти переміг!", "", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                resetGame();
            }
